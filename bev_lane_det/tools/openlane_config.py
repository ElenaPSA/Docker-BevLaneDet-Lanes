...
import numpy as np
from loader.bev_road.openlane_data import OpenLane_dataset_with_offset, OpenLane_dataset_with_offset_val, OpenLane_dataset_with_offset_classif, OpenLane_dataset_2d

''' data split '''
train_gt_paths = '/dataL/openlane/lane3d_1000/training'
train_image_paths = '/dataL/openlane/images/training'
val_gt_paths = '/dataL/openlane/lane3d_1000/validation'
val_image_paths = '/dataL/openlane/images/validation'

model_save_path = "/data/gvincent/bev_lane_det/checkpoints/openlane"
log_path = "/data/gvincent/bev_lane_det/logs/openlane/run_4"
...
if im_2d:
    ...
    from models.model.single_camera_bev_classif import BEV_LaneDet
else:
...
def train_dataset():
    ...
    if im_2d:
        train_data = OpenLane_dataset_2d(train_image_paths, train_gt_paths, 
                                         train_trans, output_2d_shape, vc_config)

    elif classif:
        train_data = OpenLane_dataset_with_offset_classif(train_image_paths, train_gt_paths, 
