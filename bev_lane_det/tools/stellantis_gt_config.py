...
model_save_path = "./bev_lane_det/checkpoints/stl_lane_postprocessed_50/"
log_path = "./bev_lane_det/logs/stl_lane_postprocessed_50/"
...
def val_dataset(
    dataset_path=root_path, gt_type=gt_type, transformations=val_transforms, **kwargs
):
    dataset = Stellantis_gt_dataset_with_offset(
        dataset_path,
        False,
        gt_type,
        x_range,
